...
def extract_skills(resume_text):
    ...
    data = pd.read_csv(r"C:\Users\PC\Downloads\Data Science\Project2\dummies\Resume_Classification-main\skills.csv") # reading the csv file
...
# MAIN CODE
import pickle as pk
model = pk.load(open(r'C:\Users\PC\Downloads\Data Science\Project2\dummies\ModelRFC.pkl', 'rb'))
Vectorizer = pk.load(open(r'C:\Users\PC\Downloads\Data Science\Project2\dummies\VECTOR.pkl', 'rb'))
